 ...
 * Fare un programma che crea un Produttore ed un Consumatore con il seguente ruolo:
	...
	Suggerimenti
	Utilizzare quattro classi una per Produttore, una per Consumatore, una classe Buffer2 ed il Main
...
public class Main2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		Buffer2 buffer = new Buffer2 ( maxCoda );
		
		/**
		 * @brief: creare thread produttore
		 */
		Thread produttore = new Thread( new Produttore2( buffer, maxNumero, minNumero, maxAttesa, minAttesa ) );
		
		/**
		 * @brief: creare thread consumatore
		 */
		Thread consumatore = new Thread( new Consumatore2( buffer ) );
